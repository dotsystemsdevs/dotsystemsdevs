...
|---------|-------------|
| [meilisearch/meilisearch-python](https://github.com/meilisearch/meilisearch-python/pull/1228) | Dynamic Search Rules API (v1.41) |
| [TRUGS-LLC/TRUGS-AGENT](https://github.com/TRUGS-LLC/TRUGS-AGENT/pull/19) | Validator edge case tests |
| [klimanskiy1/shortener-service](https://github.com/klimanskiy1/shortener-service/pull/4) | DB transaction refactor |
| [klimanskiy1/shortener-service](https://github.com/klimanskiy1/shortener-service/pull/5) | Unit test suite |
| [NovaCode37/Prism-platform](https://github.com/NovaCode37/Prism-platform/pull/7) | Dark/light theme toggle |
| [manytask/manytask](https://github.com/manytask/manytask/pull/917) | Line numbers in student table |
| [Build-Break-Repeat/CTF_Framework](https://github.com/Build-Break-Repeat/CTF_Framework/pull/15) | Config file rename refactor |
